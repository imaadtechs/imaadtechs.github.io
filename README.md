    ...
    <div class="lab-content">
      ...
      <div class="lab-hud">
        ...
        <div class="hud-row">
          ...
          <span class="hud-val" id="telemetry-ping">PINGING...</span>
        </div>
      </div>

      <div class="embed-container">
        <div class="embed-title">Sound Module Alpha</div>
        <iframe
          width="100%"
          height="160"
      ...
      <div class="embed-container">
        <div class="embed-title">Sound Module Beta</div>
        <iframe
          width="100%"
          height="160"
  ...
  <script>
    ...
    setInterval(() => {
      ...
      if (pingElement) {
        ...
        pingElement.innerText = `${ms} ms (OK)`;
      }
    }, 2000);
